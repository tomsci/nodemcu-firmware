...
static const LUA_REG_TYPE generichash_state_map[] = {
  { LSTRKEY("update"), LFUNCVAL(l_crypto_generichash_update) },
  { LSTRKEY("final"), LFUNCVAL(l_crypto_generichash_final) },
  { LSTRKEY("__index"), LROVAL(generichash_state_map) },
  { LNILKEY, LNILVAL }
};
...
static const LUA_REG_TYPE sodium_map[] = {
  ...
  { LSTRKEY("generichash"), LFUNCVAL(l_crypto_generichash) },
  { LSTRKEY("generichash_init"), LFUNCVAL(l_crypto_generichash_init) },
  { LNILKEY, LNILVAL }
};
...
NODEMCU_MODULE(SODIUM, "sodium", sodium_map, luaopen_sodium);
